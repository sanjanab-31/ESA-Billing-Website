          ...
          <tr>
            <td colspan="2" rowspan="2" style="vertical-align: top;">
              ...
              <div style="margin-bottom: 10px;">
                <div class="font-bold" style="margin-bottom: 5px;">Notes:</div>
                <div style="font-size: 11px; white-space: pre-wrap;">${invoice.invoiceNotes}</div>
              </div>` : ''}
              <div class="font-bold" style="margin-bottom: 5px;">Declaration</div>
              <div style="font-size: 11px;">${invoice.declaration || "We declare that this invoice shows the actual price of the goods Described and that all Particulars are true and correct"}</div>
            </td>
