...
export const generateInvoiceHTML = (invoice, settings = null) => {
  ...
  return `
    ...
    <head>
      ...
      <style>
        body { font-family: "Mazzard", sans-serif; margin: 0; padding: 20px; background-color: #fff; font-size: 12px; }
        ...
        .company-name { font-family: 'Mazzard', sans-serif; font-size: 32px; font-weight: bold; color: #FF0000; margin: 0; text-transform: uppercase; }
      ...
      <div class="container">
        ...
        <div style="display: flex; border-bottom: 1px solid black;">
          <div style="width: 70%; border-right: 1px solid black; padding: 5px;">
            ...
            <div style="margin-top: 5px; border-top: 1px solid black; padding-top: 5px;">GSTIN : ${invoice.client?.taxId || invoice.client?.company || invoice.client?.gst || ""}</div>
          </div>
          <div style="width: 30%;">
